<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-15 22:30:47
 * @LastEditTime: 2023-06-16 16:34:16
...
export default {
  ...
  methods: {
    ...
    sendData() {
      ...
      const api = `http://${mttIP}/energy_t6_m5_mtt/public/index.php/lowerLimbExtension/sendLowerLimbExtensionTrainData`
      console.log(api)
