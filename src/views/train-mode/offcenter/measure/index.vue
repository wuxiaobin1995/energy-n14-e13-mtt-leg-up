<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-16 15:39:23
 * @LastEditTime: 2023-06-19 22:34:24
 * @Description : 离心训练-具体测量
-->
<template>
  <div class="offcenter-measure">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/Train/离心训练.mp3`),
  ...
  methods: {
    ...
    initChart() {
      ...
      const intervalUp = (this.relativeDistance - this.original) / 15 // 上升间隔值
      const intervalDown = (this.relativeDistance - this.original) / 30 // 下降间隔值
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/offcenter-measure'),
